...
if __name__ == '__main__':
    ...
    print(f'Autonomous System States: {[s.identifier for s in SM.states]}\n')

    print(f'Autonomous System Transitions: {[s.identifier for s in SM.transitions]}\n')

    print(f'State Machine object representation: {SM.__repr__}\n')

    paths = [['off_manual', 'manual_off'],
             ['off_ready', 'ready_off'], 
             ['off_ready', 'ready_emergency', 'emergency_off'], 
             ['off_ready', 'ready_driving', 'driving_emergency', 'emergency_off'], 
             ['off_ready', 'ready_driving', 'driving_finished', 'finished_off'], 
             ['off_ready', 'ready_driving', 'driving_finished', 'finished_emergency', 'emergency_off']]
